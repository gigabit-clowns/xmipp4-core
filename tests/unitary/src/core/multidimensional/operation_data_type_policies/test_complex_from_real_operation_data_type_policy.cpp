...
)
{
    ...
    auto tc = GENERATE(
        TypePair{ numerical_type::float16, numerical_type::complex_float16 },
        TypePair{ numerical_type::float32, numerical_type::complex_float32 },
        TypePair{ numerical_type::float64, numerical_type::complex_float64 }
    );
