 ...
 *
 * `deduce_output` ensures that all inputs have the exact same arithmetic data
 * type and assigns this data type to the output.
 *
 * `validate` ensures that all input/output operands have the exact same
 * arithmetic data type.
 */
class XMIPP4_CORE_API homogeneous_arithmetic_operation_data_type_policy final
...
public:
	...
	static const homogeneous_arithmetic_operation_data_type_policy& get() noexcept;
