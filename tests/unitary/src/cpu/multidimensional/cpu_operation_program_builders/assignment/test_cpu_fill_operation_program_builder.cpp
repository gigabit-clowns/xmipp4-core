...
#include <cpu/multidimensional/cpu_operation_program_builders/assignment/cpu_fill_operation_program_builder.hpp>
...
class cpu_fill_operation_program_builder_fixture
{
public:
...
protected:
	cpu_fill_operation_program_builder builder;
...
TEST_CASE(
	"cpu_fill_operation_program_builder reports the fill_operation id",
	"[cpu_fill_operation_program_builder]"
)
{
	const cpu_fill_operation_program_builder builder;

	CHECK( builder.get_operation_id() == operation_id::of<fill_operation>() );
}

TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder::build throws when the operation is not "
	"a fill_operation",
	"[cpu_fill_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder::build throws when the output signature "
	"count is not one",
	"[cpu_fill_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder::build throws when input signatures are "
	"provided",
	"[cpu_fill_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder builds a program that fills a contiguous "
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder builds a program that casts the fill "
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder builds a program that honours a strided "
...
TEST_CASE_METHOD(
	cpu_fill_operation_program_builder_fixture,
	"cpu_fill_operation_program_builder::build throws when the fill value type "
