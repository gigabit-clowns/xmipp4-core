...
#include <cpu/multidimensional/cpu_operation_program_builders/assignment/cpu_copy_operation_program_builder.hpp>
...
class cpu_copy_operation_program_builder_fixture
{
public:
...
protected:
	cpu_copy_operation_program_builder builder;
...
TEST_CASE(
	"cpu_copy_operation_program_builder reports the copy_operation id",
	"[cpu_copy_operation_program_builder]"
)
{
	const cpu_copy_operation_program_builder builder;

	CHECK( builder.get_operation_id() == operation_id::of<copy_operation>() );
}

TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder::build throws when the operation is not "
	"a copy_operation",
	"[cpu_copy_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder::build throws when the output signature "
	"count is not one",
	"[cpu_copy_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder::build throws when the input signature "
	"count is not one",
	"[cpu_copy_operation_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder builds a program that copies a "
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder builds a program that casts the source "
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder builds a program that honours a strided "
...
TEST_CASE_METHOD(
	cpu_copy_operation_program_builder_fixture,
	"cpu_copy_operation_program_builder::build throws when the source type can "
