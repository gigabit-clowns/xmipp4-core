...
TEST_CASE("dot_operation_shape_policy infer_output should produce a scalar (rank-0) output", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy infer_output should fill multiple outputs with scalars", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy infer_output should throw when input count is wrong", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy infer_output should throw when input[0] is not 1D", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy infer_output should throw when input[1] is not 1D", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy infer_output should throw when input lengths differ", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy validate should succeed with two 1D vectors of equal length", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy validate should throw when output is not scalar", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy validate should throw when inputs have different lengths", "[dot_operation_shape_policy]")
{
    const dot_operation_shape_policy &policy = dot_operation_shape_policy::get();
...
TEST_CASE("dot_operation_shape_policy get should return the same singleton instance", "[dot_operation_shape_policy]")
{
    CHECK( &dot_operation_shape_policy::get() == &dot_operation_shape_policy::get() );
}
