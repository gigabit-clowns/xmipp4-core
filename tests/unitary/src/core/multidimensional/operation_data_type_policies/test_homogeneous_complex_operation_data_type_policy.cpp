...
TEST_CASE(
    "homogeneous_complex_operation_data_type_policy::get returns a singleton",
    "[homogeneous_complex_operation_data_type_policy]"
)
{
    CHECK( &homogeneous_complex_operation_data_type_policy::get() ==
           &homogeneous_complex_operation_data_type_policy::get() );
}

TEST_CASE(
    "homogeneous_complex_operation_data_type_policy::deduce accepts "
    "complex types",
    "[homogeneous_complex_operation_data_type_policy]"
)
{
    const auto& pol = homogeneous_complex_operation_data_type_policy::get();
...
TEST_CASE(
    "homogeneous_complex_operation_data_type_policy::deduce throws for "
    "floating-point type",
    "[homogeneous_complex_operation_data_type_policy]"
)
{
...
TEST_CASE(
    "homogeneous_complex_operation_data_type_policy::deduce throws when "
    "inputs differ",
    "[homogeneous_complex_operation_data_type_policy]"
)
{
