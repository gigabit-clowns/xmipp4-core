...
TEST_CASE("matmul_shape_policy infer_output should produce correct shape for 2D inputs", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should produce correct shape for batched inputs", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should broadcast batch dimensions", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should fill multiple outputs", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should throw when input count is wrong", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should throw when input[0] rank is less than 2", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should throw when input[1] rank is less than 2", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy infer_output should throw when inner dimensions mismatch", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should succeed with consistent shapes", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should succeed with batched shapes", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should broadcast batch inputs to match output", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should throw when m dimension mismatches", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should throw when inner dimension mismatches", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy validate should throw when n dimension mismatches", "[matmul_shape_policy]")
{
    const matmul_shape_policy &policy = matmul_shape_policy::get();
...
TEST_CASE("matmul_shape_policy get should return the same singleton instance", "[matmul_shape_policy]")
{
    CHECK( &matmul_shape_policy::get() == &matmul_shape_policy::get() );
}
