...
/**
 * @brief Compute the division and modulo from two input array to into output 
 * array.
 */
class XMIPP4_CORE_API divmod_operation final
	: public operation
{
public:
	/**
	...
	{
		OUTPUT_OPERAND_DIVISION,
		OUTPUT_OPERAND_MODULO,
