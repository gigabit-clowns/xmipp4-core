...
#include "cpp_version.hpp"
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR constexpr
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR static const
...
// C++11
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP11 XMIPP4_STATIC_CONST_CONSTEXPR
    #define XMIPP4_INLINE_CONSTEXPR_CPP11 XMIPP4_INLINE_CONSTEXPR
    #define XMIPP4_INLINE_CONST_CONSTEXPR_CPP11 constexpr
#else
    #define XMIPP4_CONSTEXPR_CPP11
    #define XMIPP4_CONST_CONSTEXPR_CPP11 const
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP11 static const
...
// C++14
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP14 XMIPP4_STATIC_CONST_CONSTEXPR
    #define XMIPP4_INLINE_CONSTEXPR_CPP14 XMIPP4_INLINE_CONSTEXPR
    #define XMIPP4_INLINE_CONST_CONSTEXPR_CPP14 constexpr
#else
    #define XMIPP4_CONSTEXPR_CPP14
    #define XMIPP4_CONST_CONSTEXPR_CPP14 const
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP14 static const
...
// C++17
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP17 XMIPP4_STATIC_CONST_CONSTEXPR
    #define XMIPP4_INLINE_CONSTEXPR_CPP17 XMIPP4_INLINE_CONSTEXPR
    #define XMIPP4_INLINE_CONST_CONSTEXPR_CPP17 constexpr
#else
    #define XMIPP4_CONSTEXPR_CPP17
    #define XMIPP4_CONST_CONSTEXPR_CPP17 const
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP17 static const
    #define XMIPP4_INLINE_CONSTEXPR_CPP17 inline
    #define XMIPP5_INLINE_CONST_CONSTEXPR_CPP17 inline const
#endif
...
// C++20
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP20 XMIPP4_STATIC_CONST_CONSTEXPR
    #define XMIPP4_INLINE_CONSTEXPR_CPP20 XMIPP4_INLINE_CONSTEXPR
    #define XMIPP4_INLINE_CONST_CONSTEXPR_CPP20 constexpr
#else
    #define XMIPP4_CONSTEXPR_CPP20
    #define XMIPP4_CONST_CONSTEXPR_CPP20 const
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP20 static const
    #define XMIPP4_INLINE_CONSTEXPR_CPP20 inline
    #define XMIPP5_INLINE_CONST_CONSTEXPR_CPP20 inline const
#endif
...
// C++23
    ...
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP23 XMIPP4_STATIC_CONST_CONSTEXPR
    #define XMIPP4_INLINE_CONSTEXPR_CPP23 XMIPP4_INLINE_CONSTEXPR
    #define XMIPP4_INLINE_CONST_CONSTEXPR_CPP23 constexpr
#else
    #define XMIPP4_CONSTEXPR_CPP23
    #define XMIPP4_CONST_CONSTEXPR_CPP23 const
    #define XMIPP4_STATIC_CONST_CONSTEXPR_CPP23 static const
    #define XMIPP4_INLINE_CONSTEXPR_CPP23 inline
    #define XMIPP5_INLINE_CONST_CONSTEXPR_CPP23 inline const
#endif