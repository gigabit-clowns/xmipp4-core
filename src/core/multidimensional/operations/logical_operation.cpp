...
const operation_shape_policy& logical_operation::get_operation_shape_policy() const noexcept
{
	return elementwise_operation_shape_policy::get();
}

const operation_data_type_policy& logical_operation::get_operation_data_type_policy() const noexcept
{
