...
TEST_CASE("matvec_operation_shape_policy infer_output should produce 1D output of length m", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy infer_output should fill multiple outputs", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy infer_output should throw when input count is wrong", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy infer_output should throw when matrix is not 2D", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy infer_output should throw when vector is not 1D", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy infer_output should throw when column count does not match vector length", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy validate should succeed with consistent shapes", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy validate should throw when output is not 1D", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy validate should throw when row count does not match output", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy validate should throw when column count does not match vector", "[matvec_operation_shape_policy]")
{
    const matvec_operation_shape_policy &policy = matvec_operation_shape_policy::get();
...
TEST_CASE("matvec_operation_shape_policy get should return the same singleton instance", "[matvec_operation_shape_policy]")
{
    CHECK( &matvec_operation_shape_policy::get() == &matvec_operation_shape_policy::get() );
}
