...
void real_from_complex_data_type_policy::infer_output(
...
) const
{
	const auto input_type = check_inputs(
		input_types,
		"real_from_complex_data_type_policy::infer_output"
	);
	fill(output_types, make_real(input_type));
}

void real_from_complex_data_type_policy::validate(
...
) const
{
	const auto input_type = check_inputs(
		input_types,
		"real_from_complex_data_type_policy::validate"
	);
...
numerical_type real_from_complex_data_type_policy::check_inputs(
	span<const numerical_type> input_types,
	const char *context
)
{
...
const real_from_complex_data_type_policy&
real_from_complex_data_type_policy::get() noexcept
{
	static const real_from_complex_data_type_policy instance;
	return instance;
}
