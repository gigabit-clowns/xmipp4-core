...
const operation_shape_policy& fft_r2c_operation::get_operation_shape_policy() const noexcept
{
	// TODO
}

const operation_data_type_policy& fft_r2c_operation::get_operation_data_type_policy() const noexcept
{
