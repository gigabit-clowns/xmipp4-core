...
TEST_CASE("score_host_affinity should return the expected score for each kind")
{
...
TEST_CASE("score_device_affinity should return the expected score for each kind")
{
...
TEST_CASE("is_host_accessible should return true iff score_host_affinity > 0")
{
...
TEST_CASE("is_device_accessible should return true iff score_device_affinity > 0")
{
