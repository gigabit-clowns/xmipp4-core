...
const shape_policy& complex_from_polar_operation::get_shape_policy() const noexcept
{
	return elementwise_shape_policy::get();
}

const data_type_policy& complex_from_polar_operation::get_data_type_policy() const noexcept
{
	return complex_from_floating_data_type_policy::get();
}

std::size_t complex_from_polar_operation::get_output_count() const noexcept { return 1; }
std::size_t complex_from_polar_operation::get_input_count() const noexcept { return 2; }
