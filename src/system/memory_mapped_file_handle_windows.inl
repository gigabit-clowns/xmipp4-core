...
inline DWORD access_flags_to_memory_map_protect(
	access_flags access,
	bool copy_on_write
)
{
...
inline DWORD access_flags_to_view_access(
	access_flags access,
	bool copy_on_write
)
{
...
inline HANDLE create_file_mapping_view(
	HANDLE mapping, 
	access_flags access,
	std::size_t size,
	bool copy_on_write
...
inline void* memory_mapped_file_open(
	const char* filename, 
	access_flags access,
	std::size_t &size,
	bool copy_on_write
