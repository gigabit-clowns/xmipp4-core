...
#include "functor_cpu_program.hpp"
...
)
{
	if (actual != expected)
	{
		...
		oss << "functor_cpu_program: expected " << expected << " " << context
...
)
{
	...
	{
		std::ostringstream oss;
		oss << "functor_cpu_program: " << context
...
inline
functor_cpu_program<F, Outputs, Inputs, Scratches>::functor_cpu_program(
...
functor_cpu_program<F, Outputs, Inputs, Scratches>
...
{
	using program_type = functor_cpu_program<
