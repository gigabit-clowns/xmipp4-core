...
static std::size_t require_same_count(
...
template<typename T, typename... Ts>
std::size_t 
dummy_communicator_helper<T, Ts...>::send_receive(
	int,
	span<const T>,
	int, 
	span<T>
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::scatter(
	int root, 
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::gather(
	int root, 
	span<const T> send_buf, 
	span<T> recv_buf
)
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::all_gather(
	span<const T> send_buf, 
	span<T> recv_buf
)
{
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::reduce(
	int root, 
	reduction_operation,
	span<const T> send_buf, 
	span<T> recv_buf
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::all_reduce(
	reduction_operation,
	span<const T> send_buf, 
	span<T> recv_buf
)
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::all_to_all(
	span<const T> send_buf, 
	span<T> recv_buf
)
{
...
template<typename T, typename... Ts>
void dummy_communicator_helper<T, Ts...>::dummy_collective_operation(
	int root,
	span<const T> send_buf, 
	span<T> recv_buf
)
