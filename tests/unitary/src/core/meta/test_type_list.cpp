...
TEST_CASE( "querying the size of a type_list should return the correct size", "[type_list]" )
{
...
TEST_CASE( "indexing elements in a type_list should return the correct element", "[type_list]" )
{
