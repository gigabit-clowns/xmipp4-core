...
std::string modulo_operation::get_name() const
{
	return "modulo";
}

const operation_shape_policy&
modulo_operation::get_operation_shape_policy() const noexcept
{
	return elementwise_operation_shape_policy::get();
}

const operation_data_type_policy&
modulo_operation::get_operation_data_type_policy() const noexcept
{
	return homogeneous_operation_data_type_policy::get();
}

operation_arity modulo_operation::get_arity() const noexcept
{
