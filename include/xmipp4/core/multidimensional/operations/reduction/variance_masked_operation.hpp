...
/**
 * @brief Masked variant of @ref variance_operation. The first input is a
 * boolean mask.
 */
class XMIPP4_CORE_API variance_masked_operation final
    : public masked_reduction_operation
{
public:
    explicit variance_masked_operation(
