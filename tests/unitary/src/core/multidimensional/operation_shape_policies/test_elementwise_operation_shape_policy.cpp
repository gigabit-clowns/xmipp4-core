...
TEST_CASE("elementwise_operation_shape_policy get should return a singleton", "[elementwise_operation_shape_policy]")
{
	const auto &a = elementwise_operation_shape_policy::get();
	const auto &b = elementwise_operation_shape_policy::get();
	CHECK( &a == &b );
}

TEST_CASE("elementwise_operation_shape_policy infer_output should produce contiguous output from single input", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy infer_output should broadcast compatible inputs", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy infer_output should broadcast inputs to output shape", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy infer_output should fill multiple outputs", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy infer_output should throw when inputs are empty", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy validate should succeed with matching shapes", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy validate should broadcast inputs to output shape", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy validate should throw when outputs are empty", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy validate should throw when multiple outputs have different extents", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
...
TEST_CASE("elementwise_operation_shape_policy validate should throw when output has broadcasted (zero stride) dimensions", "[elementwise_operation_shape_policy]")
{
	const auto &policy = elementwise_operation_shape_policy::get();
