...
#include <backends/cpu/builders/assignment/copy_program_builder.hpp>
...
TEST_CASE(
	"copy_program_builder reports the copy_operation id",
	"[copy_program_builder]"
)
{
	const copy_program_builder builder;
...
TEST_CASE_METHOD(
	...
	"copy_program_builder::build throws when the operation is not "
	"a copy_operation",
	"[copy_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder::build throws when the output signature "
	"count is not one",
	"[copy_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder::build throws when the input signature "
	"count is not one",
	"[copy_program_builder]"
)
{
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder builds a program that copies a "
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder builds a program that casts the source "
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder builds a program that honours a strided "
...
TEST_CASE_METHOD(
	cpu_copy_program_builder_fixture,
	"copy_program_builder::build throws when the source type can "
