...
TEST_CASE("outer_shape_policy infer_output should produce a 2D output of shape (m, n)", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy infer_output should fill multiple outputs", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy infer_output should throw when input count is wrong", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy infer_output should throw when input[0] is not 1D", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy infer_output should throw when input[1] is not 1D", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy validate should succeed with consistent shapes", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy validate should throw when output is not 2D", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy validate should throw when input[0] length does not match row count", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy validate should throw when input[1] length does not match column count", "[outer_shape_policy]")
{
    const outer_shape_policy &policy = outer_shape_policy::get();
...
TEST_CASE("outer_shape_policy get should return the same singleton instance", "[outer_shape_policy]")
{
    CHECK( &outer_shape_policy::get() == &outer_shape_policy::get() );
}
