...
void homogeneous_integer_operation_data_type_policy::deduce_output(
...
void homogeneous_integer_operation_data_type_policy::validate(
...
homogeneous_integer_operation_data_type_policy::get() noexcept
{
	static const homogeneous_integer_operation_data_type_policy instance;
	return instance;
}
