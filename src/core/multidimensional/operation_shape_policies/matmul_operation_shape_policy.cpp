...
void matmul_operation_shape_policy::infer_output(
...
) const
{
    if (input_layouts.size() != 2)
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::infer_output: expected exactly 2 inputs."
        );
    }
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::infer_output: input[0] must have rank >= 2."
        );
    }
    if (extents1.size() < 2)
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::infer_output: input[1] must have rank >= 2."
        );
    }
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::infer_output: inner dimensions do not match "
...
) const
{
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: expected at least 1 output."
        );
    }
    if (input_layouts.size() != 2)
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: expected exactly 2 inputs."
        );
    }
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: output must have rank >= 2."
        );
    }
    if (extents0.size() < 2)
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: input[0] must have rank >= 2."
        );
    }
    if (extents1.size() < 2)
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: input[1] must have rank >= 2."
        );
    }
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: input[0] second-to-last dim does "
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: inner dimensions do not match "
            "(input[0] last dim != input[1] second-to-last dim)."
        );
    }
    ...
    {
        throw std::invalid_argument(
            "matmul_operation_shape_policy::validate: input[1] last dim does not match "
            "output last dim (n)."
        );
    }
...
const matmul_operation_shape_policy& matmul_operation_shape_policy::get() noexcept
{
