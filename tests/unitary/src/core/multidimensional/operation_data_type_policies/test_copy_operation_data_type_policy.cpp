...
)
{
    ...
    for (auto t : { numerical_type::boolean, numerical_type::int32,
                    numerical_type::float64, numerical_type::complex_float32 })
    {
...
)
{
                    ...
                    numerical_type::complex_float32 })
    {
        ...
        CHECK_NOTHROW(
            pol.accept(make_span(user_out), make_span(canonical),
                       make_span(inputs))
        );
    }
}
