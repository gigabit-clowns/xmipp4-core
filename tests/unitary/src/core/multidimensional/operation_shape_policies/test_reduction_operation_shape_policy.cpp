...
#include <xmipp4/core/multidimensional/operation_shape_policies/reduction_operation_shape_policy.hpp>
#include <xmipp4/core/multidimensional/strided_layout.hpp>

using namespace xmipp4;
using namespace xmipp4::multidimensional;

TEST_CASE("reduction_operation_shape_policy infer_output should reduce specified axes", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 1 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy infer_output should reduce multiple axes", "[reduction_operation_shape_policy]")
{
...
TEST_CASE("reduction_operation_shape_policy infer_output should broadcast compatible inputs", "[reduction_operation_shape_policy]")
{
...
TEST_CASE("reduction_operation_shape_policy infer_output should throw when inputs are empty", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 0 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy infer_output should fill multiple outputs", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 1 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should succeed with correct reduction layout", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 1 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should throw when reduction axis has non-zero stride", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 1 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should throw when non-reduction axis has zero stride", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 1 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should throw when inputs are empty", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 0 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should throw when multiple outputs have different extents", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 0 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
...
TEST_CASE("reduction_operation_shape_policy validate should broadcast inputs to output shape", "[reduction_operation_shape_policy]")
{
	const std::vector<std::size_t> reduction_axes = { 0 };
	reduction_operation_shape_policy policy(make_span(reduction_axes));
