...
/**
 * @brief Base class for reduction operations over real (non-complex) types.
 *
 * `operation_shape_policy`: @c reduction_operation_shape_policy (inherited)
 * `operation_data_type_policy`: @c homogeneous_real_operation_data_type_policy
 */
class XMIPP4_CORE_API real_reduction_operation
