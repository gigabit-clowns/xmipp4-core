...
{
public:
    kernel_access_layout_implementation(std::vector<std::size_t> batch_extents);
...
private:
    ...
    std::vector<kernel_access_layout_operand> m_operands;
...
#include "kernel_access_layout_implementation.inl"
